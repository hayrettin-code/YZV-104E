...
void get_equation( int **a1, int **a2, int **b1, int **b2,
                    int **c1, int **c2);
...
int main() {
  ...
  get_equation(&a1, &a2, &b1, &b2, &c1, &c2);
...
void get_equation(int **a1, int **a2, int **b1, int **b2,
  ...
  *a1 = (int*) malloc(1*sizeof(int));
  *a2 = (int*) malloc(1*sizeof(int));
  *b1 = (int*) malloc(1*sizeof(int));
  *b2 = (int*) malloc(1*sizeof(int));
  *c1 = (int*) malloc(1*sizeof(int));
  *c2 = (int*) malloc(1*sizeof(int));
...
double calculate_x_or_y( int *a1, int *a2, int *b1, int *b2,
   ...
   switch(x_or_y){
     case 'x': return (1.0) *
                      (c1[index]*b2[index] - b1[index]*c2[index])
                      /
                      (a1[index]*b2[index] - b1[index]*a2[index]);
     case 'y': return (1.0) *
                      (a1[index]*c2[index] - c1[index]*a2[index])
                      /
                      (a1[index]*b2[index] - b1[index]*a2[index]);
     default:
